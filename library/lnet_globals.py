...
DOCUMENTATION = """
---
module: lnet_globals.py
short_description: Configure lnet global tunables dynamically via lnetctl
description:
  - Uses lnetctl to dynamically update 'lnetctl set' parameters on-the-fly
options:
  enable:
    description:
